<template>
  <div>
    ...
    <div class="my-0 mx-0">
      <highcharts class="chart" :options="chartOptions" v-if="data !== null && data.data !== undefined && !reload"></highcharts>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    chartOptions() {
      ...
      return this.makeChart(this.height, this.data, this.interval);
    }
  },
  methods: {
    prepareSeries(data) {
