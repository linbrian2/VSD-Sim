              ...
              <div class="d-flex align-center mr-1 mt-n2">
                <v-tooltip left>
                  <template v-slot:activator="{ on }">
                    <v-btn icon v-on="on" @click.stop="centerSegment">
...
import ChartDialog from '@/components/traffic/common/ChartDialog';
import VideoPlayerDialog from '@/components/traffic/common/VideoPlayerDialog';
import TimingPlan from '@/components/traffic/dashboard/TimingPlan';
// import TimingPlans from '@/components/traffic/dashboard/TimingPlans';
