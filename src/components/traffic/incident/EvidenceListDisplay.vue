<template>
  <v-container>
    ...
    <v-row>
      ...
      <!-- <v-col cols="3">
        <DataCard title="Severity">
          <div class="d-flex justify-center align-center">
            <v-progress-circular :size="130" :width="2" :value="100" :color="severityColor" class="mt-3">
              <span class="score-value"> {{ incidentScore }}</span>
            </v-progress-circular>
          </div>
        </DataCard>
      </v-col> -->
...
import DataCard from '@/components/traffic/common/DataCard';
import IncidentTypeCard from '@/components/traffic/incident/IncidentTypeCard';
import WeatherInfo from '@/components/traffic/common/WeatherInfo';
import WazeInfo from '@/components/traffic/common/WazeInfo';
import RestrictionInfo from '@/components/traffic/common/RestrictionInfo';
import SegmentHeader from '@/components/traffic/incident/SegmentHeader';
import TrafficAlertInfo from '@/components/traffic/incident/TrafficAlertInfo';
import TrafficFlowData from '@/components/traffic/incident/TrafficFlowData';
import TravelTimeData from '@/components/traffic/incident/TravelTimeData';
import IncidentVideoList from '@/components/traffic/incident/IncidentVideoList';
